      ...
      <div className="px-6 md:px-12 lg:px-20 pb-24 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <div className="space-y-8">
            <div>
              {show.subtitle && (
                <p className="text-sm italic mb-2" style={{ fontFamily: "var(--font-cormorant)", color: "#6B5C50" }}>
                  {show.subtitle}
                </p>
              )}
              <h1
                    ...
                    {(() => {
                      ...
                      return (
                        <>
                          ...
                          {rest && <span style={{ color: "#6B5C50", marginLeft: 4 }}>{rest}</span>}
                        </>
                      );
                    })()}
                  </span>
            ...
            {/* Description */}
            <div>
              <p className="text-xs tracking-[0.2em] uppercase mb-3" style={{ fontFamily: "var(--font-inter)", color: "#6B5C50" }}>
                작품 소개
              </p>
