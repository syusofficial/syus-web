        ...
        {results !== null && (
          <div className="mt-8 p-5" style={{ backgroundColor: "#E6E1D6" }}>
            {results.length === 0 ? (
              ...
              <div>
                <p className="text-xs tracking-wider uppercase mb-3" style={{ fontFamily: "var(--font-inter)", color: "#5A4A3E" }}>
                  가입된 이메일
                </p>
                ...
                <p className="mt-4 text-xs leading-relaxed" style={{ fontFamily: "var(--font-noto-sans-kr)", color: "#5A4A3E" }}>
                  보안을 위해 일부만 표시됩니다.
                  <br />
