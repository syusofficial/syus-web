...
export const metadata: Metadata = {
  title: "소개",
  description:
    "무대올림은 대학 무대예술 공연을 올리고, 지역 관객이 관람료 없이 좌석을 예약하는 플랫폼입니다. 공연팀 게재료 없음. 연극·뮤지컬·무용·발레·국악·음악·전통연희. 운영: 사유유사 SYUS.",
  alternates: { canonical: "https://syus.co.kr/about" },
  openGraph: {
    title: "소개 · 무대올림",
    description:
      "대학 무대예술 공연을 올리고, 지역 관객이 관람료 없이 좌석을 예약하는 플랫폼. 공연팀 게재료 없음. 운영: 사유유사 SYUS.",
            ...
            {[
              ...
              },
              {
                ...
                body: [
                  ...
                  "관객 결제도 없고, 공연팀(공연자·학과)에게 등록·게재 수수료를 받지 않으며, 광고·구독·제휴로 운영됩니다.",
