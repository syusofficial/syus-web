export type Show = {
  ...
  // 신규 카테고리 / 상세 필드
  genre?: string;              // 연극 | 뮤지컬 | 무용 | 국악 | 음악 | 전통연희 | 기타 (2026-07-28 오후: 순수/실용무용 분리 되돌림, 호버 메뉴로 대체)
  genre_detail?: string;       // 무용 → 한국무용·발레·현대무용·대중무용·댄스(순수/실용무용은 UI 그룹핑일 뿐) / 음악 → 성악·피아노·관현악·실용음악
